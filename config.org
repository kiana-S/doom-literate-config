...
#+property: header-args :mkdirp yes :results silent :exports code :eval no-export
...
#+name: confpkg
#+begin_src emacs-lisp :var name="" needs="" after="" pre="" prefix="config-" via="copy" :results silent raw
...
want to open my agenda, it's to see a specific view.
